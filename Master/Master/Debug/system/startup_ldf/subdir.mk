...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="Master" -proc ADSP-BF537 -si-revision any -g -DCORE0 -D_DEBUG @includes-625938c8c7b2070dbb0674f7f24529b1.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
